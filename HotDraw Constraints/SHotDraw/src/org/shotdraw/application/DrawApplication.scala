...
//    setTool(new NullTool(this), "")
  ...
  protected def createAttributesMenu: JMenu = {
    val menu = new CommandMenu("Attributes")
    ...
    menu.addSeparator
    menu.add(new UndoableCommand(new ResizeCommand("Resize", this)), KeyStroke.getKeyStroke('0', InputEvent.CTRL_DOWN_MASK))
    menu
  }
  ...
  protected def createAlignMenu: JMenu = {
    ...
    menu.add(new UndoableCommand(new AlignCommand("Bottom", BottomAlignFactory, this)))
