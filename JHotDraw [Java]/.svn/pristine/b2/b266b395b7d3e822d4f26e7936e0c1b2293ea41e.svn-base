...
public class HandleEnumerator implements HandleEnumeration {
	private Iterator<Handle> myIterator;
	private Collection<Handle> myInitialCollection;

	private static HandleEnumerator singletonEmptyEnumerator =
		new HandleEnumerator(new ArrayList<Handle>());

	public HandleEnumerator(Collection<Handle> c) {
