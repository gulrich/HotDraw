...
public class NullDrawingView extends JPanel implements DrawingView {
	...
	private static final long serialVersionUID = 2998621686568305779L;
	...
	private static Hashtable<DrawingEditor, DrawingView> drawingViewManager = new Hashtable<DrawingEditor, DrawingView>();
