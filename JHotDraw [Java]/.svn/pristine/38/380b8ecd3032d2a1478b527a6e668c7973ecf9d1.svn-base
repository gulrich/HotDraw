...
public	class DrawApplication extends JFrame implements DrawingEditor, PaletteListener, VersionRequester {
	...
	private static final long serialVersionUID = 4741862790087996224L;
	
	public static final String TITLE = "JHotDraw";
	...
	protected JMenu createEditMenu() {
		...
		menu.add(new UndoableCommand(
			new SelectAllCommand("Select All", this)), KeyStroke.getKeyStroke('A', InputEvent.CTRL_DOWN_MASK));
		menu.addSeparator();
		menu.add(new UndoableCommand(
			new CutCommand("Cut", this)), KeyStroke.getKeyStroke('X', InputEvent.CTRL_DOWN_MASK));
		menu.add(new CopyCommand("Copy", this), KeyStroke.getKeyStroke('C', InputEvent.CTRL_DOWN_MASK));
		menu.add(new UndoableCommand(
			new PasteCommand("Paste", this)), KeyStroke.getKeyStroke('V', InputEvent.CTRL_DOWN_MASK));
		menu.addSeparator();
		menu.add(new UndoableCommand(
			new DuplicateCommand("Duplicate", this)), KeyStroke.getKeyStroke('D', InputEvent.CTRL_DOWN_MASK));
...
//		return new JScrollPaneDesktop();
	...
	*/
	...
	protected void fireViewSelectionChangedEvent(DrawingView oldView, DrawingView newView) {
		ListIterator<ViewChangeListener> li= listeners.listIterator(listeners.size());
