...
public class Iconkit {
	private Map<String, Image>                 fMap;
	private List<String>                fRegisteredImages;
	...
	public Iconkit(Component component) {
		fMap = new Hashtable<String, Image>();
		fRegisteredImages = new ArrayList<String>();
	...
	public void loadRegisteredImages(Component component) {
		...
		Iterator<String> iter = fRegisteredImages.iterator();
		while (iter.hasNext()) {
