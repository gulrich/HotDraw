...
public  class PolyLineFigure extends AbstractFigure {
	...
	public PolyLineFigure(int size) {
		fPoints = new ArrayList<Point>(size);
	}

	public PolyLineFigure(int x, int y) {
		fPoints = new ArrayList<Point>();
		fPoints.add(new Point(x, y));
	}

	public Rectangle displayBox() {
		Iterator<Point> iter = points();
		if (iter.hasNext()) {
	...
	public HandleEnumeration handles() {
		List<Handle> handles = new ArrayList<Handle>(fPoints.size());
