...
public class CutCommand extends FigureTransferCommand {
	...
	public void execute() {
		...
		List<Figure> affected = new ArrayList<Figure>();
		Figure f;
	...
	public static class UndoActivity extends UndoableAdapter {
		...
		private List<Figure> mySelectedFigures;
		...
		protected void rememberSelectedFigures(FigureEnumeration toBeRemembered) {
			mySelectedFigures = new ArrayList<Figure>();
		...
		public FigureEnumeration getSelectedFigures() {
			return new FigureEnumerator(new ArrayList<Figure>(mySelectedFigures));
		}
