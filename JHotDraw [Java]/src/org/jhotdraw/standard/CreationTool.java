...
public class CreationTool extends AbstractTool {
	 ...
	 */
	private List<Figure>    fAddedFigures;
	...
	public void activate() {
		...
		setAddedFigures(new ArrayList<Figure>());
	}
	 ...
	 */
	protected List<Figure> getAddedFigures() {
	 ...
	 */
	protected void setAddedFigures(List<Figure> newAddedFigures) {
