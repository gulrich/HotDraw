...
public  class CommandMenu extends JMenu implements ActionListener, CommandListener {
	...
	private static final long serialVersionUID = 4711447162033387533L;
	
	private HashMap<JMenuItem, Command>  hm;

	public CommandMenu(String name) {
		super(name);
		hm = new HashMap<JMenuItem, Command>();
	}
	 ...
	 * the command's name.
	 */
	public synchronized void add(Command command, KeyStroke ks) {
